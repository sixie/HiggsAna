//================================================================================================
// root -l -b -q ZeeGammaMassFitSystematicStudy.C+'("/afs/cern.ch/work/s/sixie/public/releases/CMSSW_5_2_3_patch1/src/HiggsAna/HZZ4l/Efficiency/results/Data2012_EleHZZICHEP2012WPWithZeeGamma/basic2_76_106_LowPt/plots/FitWorkspaceFile_etapt_0.root",1234,0,3)'
