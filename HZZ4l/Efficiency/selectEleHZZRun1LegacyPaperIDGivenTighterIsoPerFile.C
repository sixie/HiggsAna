...
void selectEleHZZRun1LegacyPaperIDGivenTighterIsoPerFile(const string inputfile,          // input file
...
// 	    continue;
        ...
        Bool_t passTighterIsolation = PassEleHZZ4lICHEP2012TighterIso(probe,j,pfcandidateArr,rhoEleIso,EleEAEra,photonsToVeto);
        if (!passTighterIsolation) continue;
