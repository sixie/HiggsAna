...
// foreach f(`cat fileListA2 | grep HZZ4lNtuple | grep r12a-dmu-pr-v1`)
// root -l -b -q HiggsAna/HZZ4l/Skimming/SkimFourLeptonPerFile.C+\(\"root://eoscms//eos/cms/store/user/sixie/hist/AllNtuple/cern/filefi/028/$f\",\"/data/smurf/sixie/hist/HZZ4lNtuples/data/unprocessed/$f.FourLeptonSkimmed.root\"\)
// end
// foreach f(`cat fileListB2 | grep HZZ4lNtuple | grep r12b-del-pr-v1`)
// root -l -b -q HiggsAna/HZZ4l/Skimming/SkimFourLeptonPerFile.C+\(\"root://eoscms//eos/cms/store/group/phys_higgs/cmshzz4l/sixie/hist/AllNtuple/cern/filefi/028/$f\",\"/data/smurf/sixie/hist/HZZ4lNtuples/data/unprocessed/$f.FourLeptonSkimmed.root\"\)
// end
// foreach f(`cat fileListEGamma2 | grep HZZ4lNtuple | grep r12b-del-pr-v1`)
// root -l -b -q HiggsAna/HZZ4l/Skimming/SkimFourLeptonPerFile.C+\(\"root://eoscms//eos/cms/store/group/phys_egamma/sixie/hist/AllNtuple/cern/filefi/028/$f\",\"/tmp/sixie/$f.FourLeptonSkimmed.root\"\)
// end
// foreach f(`cat fileListMuon2 | grep HZZ4lNtuple | grep r12b-dmu-pr-v1`)
// root -l -b -q HiggsAna/HZZ4l/Skimming/SkimFourLeptonPerFile.C+\(\"root://eoscms//eos/cms/store/group/phys_muon/sixie/hist/AllNtuple/cern/filefi/028/$f\",\"/tmp/sixie/$f.FourLeptonSkimmed.root\"\)
// end
// foreach f(`cat fileListHiggsHZZ4l2 | grep HZZ4lNtuple | grep r12b-mueg`)
// root -l -b -q HiggsAna/HZZ4l/Skimming/SkimFourLeptonPerFile.C+\(\"root://eoscms//eos/cms/store/group/phys_higgs/cmshzz4l/sixie/hist/AllNtuple/cern/filefi/028/$f\",\"/tmp/sixie/$f.FourLeptonSkimmed.root\"\)
// end
//
// *************************************
// From BLUE
...
//root -l -b -q HiggsAna/HZZ4l/Skimming/SkimFourLeptonPerFile.C+\(\"$f\",\"$f.FourLeptonSkimmed.root\"\)
//end
//
// *************************************
...
// Main macro function
//--------------------------------------------------------------------------------------------------
void SkimFourLeptonPerFile(string inputFilename, string outputFilename) 
{
  ...
  for(UInt_t ientry=0; ientry<eventTree->GetEntries(); ientry++) { 
    ...
    for(Int_t i=0; i<electronArr->GetEntries(); i++) {
      ...
      if ( fabs(ele->eta) < 2.5 && ele->pt > 5.0 ) {
        NRecoElectrons++;
      }
    }

    //Two Tight (same flavor) AND Three Reco
    if (!( NRecoMuons + NRecoElectrons >= 4 
          )
      ) {
      keep = kFALSE;
    }
