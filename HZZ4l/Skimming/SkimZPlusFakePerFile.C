...
// root -l -b -q HiggsAna/HZZ4l/Skimming/SkimZPlusFakePerFile.C+\(\"root://eoscms//eos/cms/store/user/sixie/hist/AllNtuple/cern/filefi/028/$f\",\"/data/smurf/sixie/hist/HZZ4lNtuples/data/unprocessed/$f.ZPlusFakeSkimmed.root\"\)
// end
// foreach f(`cat fileListB2 | grep HZZ4lNtuple | grep r12b-del-pr-v1`)
// root -l -b -q HiggsAna/HZZ4l/Skimming/SkimZPlusFakePerFile.C+\(\"root://eoscms//eos/cms/store/group/phys_higgs/cmshzz4l/sixie/hist/AllNtuple/cern/filefi/028/$f\",\"/data/smurf/sixie/hist/HZZ4lNtuples/data/unprocessed/$f.ZPlusFakeSkimmed.root\"\)
// end
// foreach f(`cat fileListEGamma2 | grep HZZ4lNtuple | grep r12b-del-pr-v1`)
// root -l -b -q HiggsAna/HZZ4l/Skimming/SkimZPlusFakePerFile.C+\(\"root://eoscms//eos/cms/store/group/phys_egamma/sixie/hist/AllNtuple/cern/filefi/028/$f\",\"/tmp/sixie/$f.ZPlusFakeSkimmed.root\"\)
// end
// foreach f(`cat fileListMuon2 | grep HZZ4lNtuple | grep r12b-dmu-pr-v1`)
// root -l -b -q HiggsAna/HZZ4l/Skimming/SkimZPlusFakePerFile.C+\(\"root://eoscms//eos/cms/store/group/phys_muon/sixie/hist/AllNtuple/cern/filefi/028/$f\",\"/tmp/sixie/$f.ZPlusFakeSkimmed.root\"\)
// end
//
// *************************************
// From BLUE
...
//root -l -b -q HiggsAna/HZZ4l/Skimming/SkimZPlusFakePerFile.C+\(\"$f\",\"$f.ZPlusFakeSkimmed.root\"\)
//end
//
// *************************************
...
// Main macro function
//--------------------------------------------------------------------------------------------------
void SkimZPlusFakePerFile(string inputFilename, string outputFilename) 
{
  ...
  for(UInt_t ientry=0; ientry<eventTree->GetEntries(); ientry++) { 
    ...
    if (!( (NTightElectrons >= 2 || NTightMuons >= 2  )
           && NRecoElectrons + NRecoMuons >= 3
          ) ) {
      keep = kFALSE;
    }
