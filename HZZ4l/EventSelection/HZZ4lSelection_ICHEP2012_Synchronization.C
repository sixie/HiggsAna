...
void HZZ4lSelection_ICHEP2012_Synchronization(Int_t Option = 0) 
{  
  ...
  if (Option == 0) {
    inputFiles.back().push_back("/data/blue/sixie/HZZ4l/Synchronization/BACON/AllNtuple_HZZ4lNtuple_f11-h120zz4l-gf-v14b-pu_syncfile_40E86BD8-0BF0-E011-BA16-00215E21D5C4.root");
  } 
  if (Option == 1) {
    inputFiles.back().push_back("/data/blue/sixie/HZZ4l/Synchronization/BACON/AllNtuple_HZZ4lNtuple_s12-h120zz4l-gf-v9_syncfile_0CAA68E2-3491-E111-9F03-003048FFD760.root");
  }
...
//             if (minGenLeptonDR > higgsana::MathUtils::DeltaR(gen->phi,gen->eta,p2->phi,p2->eta)) {
//               minGenLeptonDR = higgsana::MathUtils::DeltaR(gen->phi,gen->eta,p2->phi,p2->eta);
//             }
//           }
//         }
