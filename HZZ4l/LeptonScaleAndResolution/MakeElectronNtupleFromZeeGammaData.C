...
//=== MAIN MACRO =================================================================================================
void MakeElectronNtupleFromZeeGammaData() {
...
void MakeElectronNtupleFromZeeGammaData(const string inputFilename, const string outputFilename, Int_t dataType) {
...
//       }
        ...
        for(Int_t j=0; j<photonArr->GetEntriesFast(); ++j) {
          ...
          for(Int_t k=0; k<electronArr->GetEntriesFast(); ++k) {
            ...
            higgsana::TElectron *probe = (higgsana::TElectron*)((*electronArr)[k]);
...
//             //perform adhoc correction to E/P for low pT electrons
//             if( probe->pt >7 && probe->pt < 10) {
//               probe->EOverP = probe->EOverP * 1.1;
//               probe->EEleClusterOverPout = probe->EEleClusterOverPout * 1.025;
//               probe->EcalEnergy = probe->EcalEnergy * 0.95;
//             }

            NElectronsFilled++;
            FillElectronTree( eleTree, probe, j, pfcandidateArr, eleIDMVA, rhoEleIso, EleEAEra, 
