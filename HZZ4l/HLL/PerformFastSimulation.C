// root -l HiggsAna/HZZ4l/HLL/PerformFastSimulation.C+'("HZZEventNtuple_ZZ.root","HZZEventNtuple_ZZ_FastSimFromHist.root","ZZ",1)'
// root -l HiggsAna/HZZ4l/HLL/PerformFastSimulation.C+'("HZZEventNtuple_HZZ125.root","HZZEventNtuple_HZZ125_FastSimFromHist.root","ZZ",1)'
...
//     LeptonResponseFile = new TFile("HiggsAna/HZZ4l/HLL/LeptonResolutionData/PtResolution_ZZ.root","READ");
    LeptonResponseFile = new TFile("fitsSave/PtResolutionModel_ZZ.root","READ");
  } else if (Option == 1) {
...
//         Lep1Efficiency = GetElectronEfficiencyPtEtaPhi(hzzEventTree.fGenLep1Pt, fabs(hzzEventTree.fGenLep1Eta), hzzEventTree.fGenLep1Phi);
        Lep1Efficiency = GetElectronEfficiencyPtEta(hzzEventTree.fGenLep1Pt, fabs(hzzEventTree.fGenLep1Eta));
        if (Option==0) {
...
//         Lep1Efficiency = GetMuonEfficiencyPtEtaPhi(hzzEventTree.fGenLep1Pt, fabs(hzzEventTree.fGenLep1Eta), hzzEventTree.fGenLep1Phi);
        Lep1Efficiency = GetMuonEfficiencyPtEta(hzzEventTree.fGenLep1Pt, fabs(hzzEventTree.fGenLep1Eta));
        if (Option==0) {
...
//         Lep2Efficiency = GetElectronEfficiencyPtEtaPhi(hzzEventTree.fGenLep2Pt, fabs(hzzEventTree.fGenLep2Eta), hzzEventTree.fGenLep2Phi);
        Lep2Efficiency = GetElectronEfficiencyPtEta(hzzEventTree.fGenLep2Pt, fabs(hzzEventTree.fGenLep2Eta));
        if (Option==0) {
...
//         Lep2Efficiency = GetMuonEfficiencyPtEtaPhi(hzzEventTree.fGenLep2Pt, fabs(hzzEventTree.fGenLep2Eta), hzzEventTree.fGenLep2Phi);
        Lep2Efficiency = GetMuonEfficiencyPtEta(hzzEventTree.fGenLep2Pt, fabs(hzzEventTree.fGenLep2Eta));
        if (Option==0) {
...
//         Lep3Efficiency = GetElectronEfficiencyPtEtaPhi(hzzEventTree.fGenLep3Pt, fabs(hzzEventTree.fGenLep3Eta), hzzEventTree.fGenLep3Phi);
        Lep3Efficiency = GetElectronEfficiencyPtEta(hzzEventTree.fGenLep3Pt, fabs(hzzEventTree.fGenLep3Eta));
        if (Option==0) {
...
//         Lep3Efficiency = GetMuonEfficiencyPtEtaPhi(hzzEventTree.fGenLep3Pt, fabs(hzzEventTree.fGenLep3Eta), hzzEventTree.fGenLep3Phi);
        Lep3Efficiency = GetMuonEfficiencyPtEta(hzzEventTree.fGenLep3Pt, fabs(hzzEventTree.fGenLep3Eta));
        if (Option==0) {
...
//         Lep4Efficiency = GetElectronEfficiencyPtEtaPhi(hzzEventTree.fGenLep4Pt, fabs(hzzEventTree.fGenLep4Eta), hzzEventTree.fGenLep4Phi);
        Lep4Efficiency = GetElectronEfficiencyPtEta(hzzEventTree.fGenLep4Pt, fabs(hzzEventTree.fGenLep4Eta));
        if (Option==0) {
...
//         Lep4Efficiency = GetMuonEfficiencyPtEtaPhi(hzzEventTree.fGenLep4Pt, fabs(hzzEventTree.fGenLep4Eta), hzzEventTree.fGenLep4Phi);
        Lep4Efficiency = GetMuonEfficiencyPtEta(hzzEventTree.fGenLep4Pt, fabs(hzzEventTree.fGenLep4Eta));
        if (Option==0) {
...
//     cout << endl;
    ...
    //lepton pt cuts
    for( uint i=0; i<leptonFourVector.size(); i++ ) {
      if (abs(leptonType[i]) == 11) {
        if (!(leptonFourVector[i].Pt() >= 7.0 && fabs(leptonFourVector[i].Eta()) < 2.5)) passEventSelection = kFALSE;
      } else {
        if (!(leptonFourVector[i].Pt() >= 5.0 && fabs(leptonFourVector[i].Eta()) < 2.4)) passEventSelection = kFALSE;
      }
    }
...
//       cout << endl;
    ...
    hzzEventTree.fWeight = hzzEventTree.fWeight*Lep1Efficiency*Lep2Efficiency*Lep3Efficiency*Lep4Efficiency;
