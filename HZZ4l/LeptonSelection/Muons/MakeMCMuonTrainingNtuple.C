...
void MakeNtuple(const string inputFilename,  const string outputFilename, const string PUReweightFile, Bool_t SelectRealMuons, Int_t TreeType);
...
//=== MAIN MACRO =================================================================================================
void MakeMCMuonTrainingNtuple(Int_t Sample = 0) {

//Summer11 HZZ
  if (Sample == 0) {
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_s11-h115zz4l-gf-v1g1-pu_noskim_0000.root","MuonSelection.s11HZZ115.Training.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Summer11DYmm_To_Full2011.root", kTRUE,0);
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_s11-h115zz4l-gf-v1g1-pu_noskim_0000.root","MuonSelection.s11HZZ115.Testing.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Summer11DYmm_To_Full2011.root", kTRUE,1);
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_s11-h120zz4l-gf-v1g1-pu_noskim_0000.root","MuonSelection.s11HZZ120.Training.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Summer11DYmm_To_Full2011.root", kTRUE,0);
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_s11-h120zz4l-gf-v1g1-pu_noskim_0000.root","MuonSelection.s11HZZ120.Testing.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Summer11DYmm_To_Full2011.root", kTRUE,1);
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_s11-h130zz4l-gf-v1g1-pu_noskim_0000.root","MuonSelection.s11HZZ130.Training.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Summer11DYmm_To_Full2011.root", kTRUE,0);
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_s11-h130zz4l-gf-v1g1-pu_noskim_0000.root","MuonSelection.s11HZZ130.Testing.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Summer11DYmm_To_Full2011.root", kTRUE,1);    
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_s11-h140zz4l-gf-v1g1-pu_noskim_0000.root","MuonSelection.s11HZZ140.Training.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Summer11DYmm_To_Full2011.root", kTRUE,0);
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_s11-h140zz4l-gf-v1g1-pu_noskim_0000.root","MuonSelection.s11HZZ140.Testing.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Summer11DYmm_To_Full2011.root", kTRUE,1);
  }

  //Fall11 HZZ
  if (Sample == 1) {
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_f11-h115zz4l-gf-v14b-pu_noskim_0000.root","MuonSelection.f11HZZ115.Training.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kTRUE,0);
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_f11-h115zz4l-gf-v14b-pu_noskim_0000.root","MuonSelection.f11HZZ115.Testing.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kTRUE,1);
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_f11-h120zz4l-gf-v14b-pu_noskim_0000.root","MuonSelection.f11HZZ120.Training.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kTRUE,0);
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_f11-h120zz4l-gf-v14b-pu_noskim_0000.root","MuonSelection.f11HZZ120.Testing.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kTRUE,1);
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_f11-h130zz4l-gf-v14b-pu_noskim_0000.root","MuonSelection.f11HZZ130.Training.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kTRUE,0);
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_f11-h130zz4l-gf-v14b-pu_noskim_0000.root","MuonSelection.f11HZZ130.Testing.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kTRUE,1);
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_f11-h140zz4l-gf-v14b-pu_noskim_0000.root","MuonSelection.f11HZZ140.Training.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kTRUE,0);
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_f11-h140zz4l-gf-v14b-pu_noskim_0000.root","MuonSelection.f11HZZ140.Testing.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kTRUE,1);
  }
...
//  //Z->mumu
//   MakeNtuple("Fall11Zmm","MuonSelection.Fall11Zmm.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kTRUE);


//   //Z+Jets Bkg
  if (Sample == 10) {
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mcskim/AllNtuple_HZZ4lNtuple_f11-zmmm20-powheg-v14b-pu_noskim.MCFakeLeptonSkimmed.root","MuonSelection.Fall11ZJetsBkg.zmmm20.All.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kFALSE,-1);
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mcskim/AllNtuple_HZZ4lNtuple_f11-zmmm1020-powheg-v14b-pu_noskim.MCFakeLeptonSkimmed.root","MuonSelection.Fall11ZJetsBkg.zmmm1020.All.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kFALSE,-1);    
  }

  if (Sample == 11) {
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mcskim/AllNtuple_HZZ4lNtuple_f11-zeem20-powheg-v14b-pu_noskim.MCFakeLeptonSkimmed.root","MuonSelection.Fall11ZJetsBkg.zeem20.All.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kFALSE,-1);
    MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mcskim/AllNtuple_HZZ4lNtuple_f11-zeem1020-powheg-v14b-pu_noskim.MCFakeLeptonSkimmed.root","MuonSelection.Fall11ZJetsBkg.zeem1020.All.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kFALSE,-1);    
  }


//   MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mcskim/AllNtuple_HZZ4lNtuple_f11-zmmm20-powheg-v14b-pu_noskim.MCFakeLeptonSkimmed.root","MuonSelection.Fall11ZJetsBkg.zmmm20.Training.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kFALSE,0);
//   MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mcskim/AllNtuple_HZZ4lNtuple_f11-zeem20-powheg-v14b-pu_noskim.MCFakeLeptonSkimmed.root","MuonSelection.Fall11ZJetsBkg.zeem20.Training.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kFALSE,0);
//   MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mcskim/AllNtuple_HZZ4lNtuple_f11-zmmm1020-powheg-v14b-pu_noskim.MCFakeLeptonSkimmed.root","MuonSelection.Fall11ZJetsBkg.zmmm1020.Training.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kFALSE,0);
//   MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mcskim/AllNtuple_HZZ4lNtuple_f11-zeem1020-powheg-v14b-pu_noskim.MCFakeLeptonSkimmed.root","MuonSelection.Fall11ZJetsBkg.zeem1020.Training.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kFALSE,0);
//   MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mcskim/AllNtuple_HZZ4lNtuple_f11-zmmm20-powheg-v14b-pu_noskim.MCFakeLeptonSkimmed.root","MuonSelection.Fall11ZJetsBkg.zmmm20.Testing.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kFALSE,1);
//   MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mcskim/AllNtuple_HZZ4lNtuple_f11-zeem20-powheg-v14b-pu_noskim.MCFakeLeptonSkimmed.root","MuonSelection.Fall11ZJetsBkg.zeem20.Testing.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kFALSE,1);
//   MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mcskim/AllNtuple_HZZ4lNtuple_f11-zmmm1020-powheg-v14b-pu_noskim.MCFakeLeptonSkimmed.root","MuonSelection.Fall11ZJetsBkg.zmmm1020.Testing.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kFALSE,1);
//   MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mcskim/AllNtuple_HZZ4lNtuple_f11-zeem1020-powheg-v14b-pu_noskim.MCFakeLeptonSkimmed.root","MuonSelection.Fall11ZJetsBkg.zeem1020.Testing.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kFALSE,1);
...
//   MakeNtuple("/home/sixie/hist/HZZ4lNtuples/mcskim/AllNtuple_HZZ4lNtuple_f11-zeem1020-powheg-v14b-pu_noskim.MCFakeLeptonSkimmed.root","MuonSelection.Fall11ZJetsBkg.zeem1020.All.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kFALSE,-1);
  ...
  //   //TTBAR Bkg
  if (Sample == 30) {
    MakeNtuple("TTBARBkg","MuonSelection.Fall11TTBARBkg.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kFALSE,-1);
  }

//   //W+Jets
//   MakeNtuple("/home/sixie/hist/AllNtuple/HWWNtuple/mc/AllNtuple_HWWNtuple_w10-wjets-z2-v8-pu11-2l_noskim.root","MuonSelection.WJets_Winter10Skimmed.root", "/data/smurf/data/Winter11_4700ipb/auxiliar/PileupReweighting.Summer11DYmm_To_Full2011.root", kFALSE);
//   MakeNtuple("/home/sixie/hist/AllNtuple/HWWNtuple/mc/AllNtuple_HWWNtuple_s11-wjets-v11-pu_noskim.root","MuonSelection.WJets_Summer11Skimmed.root", "/data/smurf/data/Winter11_4700ipb/auxiliar/PileupReweighting.Summer11DYmm_To_Full2011.root", kFALSE);
...
{  
  ...
  Double_t LUMI = 26.5;
  TFile *fPUFile = TFile::Open(PUReweightFile.c_str());
  TH1D *fhDPU = (TH1D*)(fPUFile->Get("puWeights"));
  assert(fhDPU);
  fhDPU->SetDirectory(0);
  delete fPUFile;
  Int_t EffectiveAreaVersion = -1;
  if (PUReweightFile == "/data/smurf/sixie/Pileup/weights/PileupReweighting.Summer11DYmm_To_Full2011.root") EffectiveAreaVersion = 1; //Summer11MC
  else if (PUReweightFile == "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root") EffectiveAreaVersion = 2;  //Fall11MC
  else EffectiveAreaVersion = 0; // Data
  cout << "Using EffectiveAreaVersion " << EffectiveAreaVersion << endl;

  //*****************************************************************************************
  //Histograms
  //*****************************************************************************************
  TH1F* GenLeptonMinDR = new TH1F(("GenLeptonMinDR"+outputFilename).c_str(), ";GenLeptonMinDR;Number of Events;", 100, 0, 3.0);
  ...
  Float_t fChargedIso05;
  Float_t fGammaIso05;
  Float_t fNeutralHadronIso05;
  Float_t fIsoDeltaRMean;
  Float_t fIsoDeltaRSum;
  Float_t fIsoDensity;
  Float_t fIsoNPFCand;
  ...
  //CutBased Variables
  muTree->Branch("typeBits",&fMuTypeBits,"typeBits/i"); 
  muTree->Branch("isAllArbitrated",&fIsAllArbitrated,"isAllArbitrated/i"); 
  ...
  muTree->Branch("ChargedIso05",&fChargedIso05,"ChargedIso05/F");
  muTree->Branch("GammaIso05",&fGammaIso05,"GammaIso05/F");
  muTree->Branch("NeutralHadronIso05",&fNeutralHadronIso05,"NeutralHadronIso05/F");
  muTree->Branch("IsoDeltaRMean",&fIsoDeltaRMean,"IsoDeltaRMean/F");
  muTree->Branch("IsoDeltaRSum",&fIsoDeltaRSum,"IsoDeltaRSum/F");
  muTree->Branch("IsoDensity",&fIsoDensity,"IsoDensity/F");
  muTree->Branch("IsoNPFCand",&fIsoNPFCand,"IsoNPFCand/F");

  UInt_t NMuonsFilled = 0;
  Int_t NMuons = 0;
  Int_t NMuonsWithOverlappingLeptonThatIsNotRemoved = 0;
  Int_t NMuonsWithFakeLeptonThatWasRemoved = 0;
  ...
  if (inputFilename == "LIST") {
  ...
  } else if (inputFilename == "Fall11Zmm") {
    inputfiles.push_back("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_f11-zmmm1020-powheg-v14b-pu_noskim_0000.root");
    inputfiles.push_back("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_f11-zmmm1020-powheg-v14b-pu_noskim_0001.root");
    inputfiles.push_back("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_f11-zmmm1020-powheg-v14b-pu_noskim_0002.root");
    inputfiles.push_back("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_f11-zmmm1020-powheg-v14b-pu_noskim_0003.root");
    inputfiles.push_back("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_f11-zmmm1020-powheg-v14b-pu_noskim_0004.root");
    inputfiles.push_back("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_f11-zmmm1020-powheg-v14b-pu_noskim_0005.root");
    inputfiles.push_back("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_f11-zmmm1020-powheg-v14b-pu_noskim_0006.root");
  } else if (inputFilename == "TTBARBkg") {
    ...
    inputfiles.push_back("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_f11-tt2l-powheg-v14b-pu_noskim_0009.root");
    inputfiles.push_back("/home/sixie/hist/HZZ4lNtuples/mc/AllNtuple_HZZ4lNtuple_f11-tt2l-powheg-v14b-pu_noskim_0010.root");
  }
...
//              passEleWP95ID(ele) //Veto Option2
      ...
      for(Int_t i=0; i<genparticleArr->GetEntries(); i++) {        
        const mithep::TGenParticle *p1 = (mithep::TGenParticle*)((*genparticleArr)[i]);
        if (!(p1->status == 1 && (abs(p1->pdgid) == 11 || abs(p1->pdgid) == 13))) continue;
        for(Int_t j=i+1; j<genparticleArr->GetEntries(); j++) {
          const mithep::TGenParticle *p2 = (mithep::TGenParticle*)((*genparticleArr)[j]);
          if (!(p2->status == 1 && (abs(p2->pdgid) == 11 || abs(p2->pdgid) == 13))) continue;
          if (minGenLeptonDR > mithep::MathUtils::DeltaR(p1->phi,p1->eta,p2->phi,p2->eta)) {
            minGenLeptonDR = mithep::MathUtils::DeltaR(p1->phi,p1->eta,p2->phi,p2->eta);
          }
        }
      }

      GenLeptonMinDR->Fill(TMath::Min(minGenLeptonDR , 2.99));

      //don't include events with leptons too close together
      ...
      for(Int_t i=0; i<muonArr->GetEntries(); i++) {
        ...
        //CutBased Variables
        fMuTypeBits = mu->typeBits; 
        fIsAllArbitrated = ((mu->qualityBits & kAllArbitrated) ==  kAllArbitrated); 
        ...
        Float_t tmpChargedIso05  = 0;
        Float_t tmpGammaIso05  = 0;
        Float_t tmpNeutralHadronIso05  = 0;
        Float_t tmpIsoDeltaRMean  = 0;
        Float_t tmpIsoDeltaRSum  = 0;
        Float_t tmpIsoDensity  = 0;
        Int_t   tmpIsoNPFCand  = 0;
...
//               if (dr < 0.10) continue;
        ...
        //***********************
        //Santiago's variables
        //***********************
        fChargedIso05 = (tmpChargedIso_DR0p0To0p05 + tmpChargedIso_DR0p05To0p1 
                         + tmpChargedIso_DR0p1To0p15 + tmpChargedIso_DR0p15To0p2 
                         + tmpChargedIso_DR0p2To0p25 + tmpChargedIso_DR0p25To0p3 
                         + tmpChargedIso_DR0p3To0p4 + tmpChargedIso_DR0p4To0p5) / mu->pt;

        fGammaIso05 =  ( tmpGammaIso_DR0p0To0p05 + tmpGammaIso_DR0p05To0p1 
                         + tmpGammaIso_DR0p1To0p15 + tmpGammaIso_DR0p15To0p2 
                         + tmpGammaIso_DR0p2To0p25 + tmpGammaIso_DR0p25To0p3 
                         + tmpGammaIso_DR0p3To0p4 + tmpGammaIso_DR0p4To0p5
                         - rho*(MuonEffectiveArea(kMuGammaIsoDR0p0To0p1, mu->eta, EffectiveAreaVersion)
                                + MuonEffectiveArea(kMuGammaIsoDR0p1To0p2, mu->eta, EffectiveAreaVersion)
                                + MuonEffectiveArea(kMuGammaIsoDR0p2To0p3, mu->eta, EffectiveAreaVersion)
                                + MuonEffectiveArea(kMuGammaIsoDR0p3To0p4, mu->eta, EffectiveAreaVersion)
                                + MuonEffectiveArea(kMuGammaIsoDR0p4To0p5, mu->eta, EffectiveAreaVersion)
                           ) ) / mu->pt;
          
        fNeutralHadronIso05 =  ( tmpNeutralHadronIso_DR0p0To0p05 + tmpNeutralHadronIso_DR0p05To0p1 
                         + tmpNeutralHadronIso_DR0p1To0p15 + tmpNeutralHadronIso_DR0p15To0p2 
                         + tmpNeutralHadronIso_DR0p2To0p25 + tmpNeutralHadronIso_DR0p25To0p3 
                         + tmpNeutralHadronIso_DR0p3To0p4 + tmpNeutralHadronIso_DR0p4To0p5
                         - rho*(MuonEffectiveArea(kMuNeutralHadronIsoDR0p0To0p1, mu->eta, EffectiveAreaVersion)
                                + MuonEffectiveArea(kMuNeutralHadronIsoDR0p1To0p2, mu->eta, EffectiveAreaVersion)
                                + MuonEffectiveArea(kMuNeutralHadronIsoDR0p2To0p3, mu->eta, EffectiveAreaVersion)
                                + MuonEffectiveArea(kMuNeutralHadronIsoDR0p3To0p4, mu->eta, EffectiveAreaVersion)
                                + MuonEffectiveArea(kMuNeutralHadronIsoDR0p4To0p5, mu->eta, EffectiveAreaVersion)
                           ) ) / mu->pt;

        fIsoDeltaRMean = tmpIsoDeltaRSum / TMath::Max(1.0, double(tmpIsoNPFCand));
        fIsoDeltaRSum = tmpIsoDeltaRSum;
        fIsoDensity = tmpIsoDensity;
        fIsoNPFCand = tmpIsoNPFCand;
        ...
        fGammaIso_DR0p0To0p1   = TMath::Max(TMath::Min((tmpGammaIso_DR0p0To0p05 + tmpGammaIso_DR0p05To0p1 - rho*MuonEffectiveArea(kMuGammaIsoDR0p0To0p1, mu->eta, EffectiveAreaVersion))/mu->pt, 2.5), 0.0);
        fGammaIso_DR0p1To0p2   = TMath::Max(TMath::Min((tmpGammaIso_DR0p1To0p15 + tmpGammaIso_DR0p15To0p2 - rho*MuonEffectiveArea(kMuGammaIsoDR0p1To0p2, mu->eta, EffectiveAreaVersion))/mu->pt, 2.5), 0.0);
        fGammaIso_DR0p2To0p3 = TMath::Max(TMath::Min((tmpGammaIso_DR0p2To0p25 + tmpGammaIso_DR0p25To0p3 - rho*MuonEffectiveArea(kMuGammaIsoDR0p2To0p3, mu->eta, EffectiveAreaVersion))/mu->pt, 2.5), 0.0);
        fGammaIso_DR0p3To0p4 = TMath::Max(TMath::Min((tmpGammaIso_DR0p3To0p4 - rho*MuonEffectiveArea(kMuGammaIsoDR0p3To0p4, mu->eta, EffectiveAreaVersion))/mu->pt, 2.5), 0.0);
        fGammaIso_DR0p4To0p5 = TMath::Max(TMath::Min((tmpGammaIso_DR0p4To0p5 - rho*MuonEffectiveArea(kMuGammaIsoDR0p4To0p5, mu->eta, EffectiveAreaVersion))/mu->pt, 2.5), 0.0);
        fGammaIso_DR0p5To0p7 = TMath::Max(TMath::Min((tmpGammaIso_DR0p5To0p7 - rho*MuonEffectiveArea(kMuGammaIsoDR0p5To0p7, mu->eta, EffectiveAreaVersion))/mu->pt, 2.5), 0.0);
        fGammaIso_DR0p7To1p0 = TMath::Max(TMath::Min((tmpGammaIso_DR0p7To1p0 - rho*MuonEffectiveArea(kMuGammaIsoDR0p7To1p0, mu->eta, EffectiveAreaVersion))/mu->pt, 2.5), 0.0);
        fNeutralHadronIso_DR0p0To0p1   = TMath::Max(TMath::Min((tmpNeutralHadronIso_DR0p0To0p05 + tmpNeutralHadronIso_DR0p05To0p1 - rho*MuonEffectiveArea(kMuNeutralHadronIsoDR0p0To0p1, mu->eta, EffectiveAreaVersion))/mu->pt, 2.5), 0.0);
        fNeutralHadronIso_DR0p1To0p2   = TMath::Max(TMath::Min((tmpNeutralHadronIso_DR0p1To0p15 + tmpNeutralHadronIso_DR0p15To0p2 - rho*MuonEffectiveArea(kMuNeutralHadronIsoDR0p1To0p2, mu->eta, EffectiveAreaVersion))/mu->pt, 2.5), 0.0);
        fNeutralHadronIso_DR0p2To0p3 = TMath::Max(TMath::Min((tmpNeutralHadronIso_DR0p2To0p25 + tmpNeutralHadronIso_DR0p25To0p3 - rho*MuonEffectiveArea(kMuNeutralHadronIsoDR0p2To0p3, mu->eta, EffectiveAreaVersion))/mu->pt, 2.5), 0.0);
        fNeutralHadronIso_DR0p3To0p4 = TMath::Max(TMath::Min((tmpNeutralHadronIso_DR0p3To0p4 - rho*MuonEffectiveArea(kMuNeutralHadronIsoDR0p3To0p4, mu->eta, EffectiveAreaVersion))/mu->pt, 2.5), 0.0);
        fNeutralHadronIso_DR0p4To0p5 = TMath::Max(TMath::Min((tmpNeutralHadronIso_DR0p4To0p5 - rho*MuonEffectiveArea(kMuNeutralHadronIsoDR0p4To0p5, mu->eta, EffectiveAreaVersion))/mu->pt, 2.5), 0.0);
        fNeutralHadronIso_DR0p5To0p7 = TMath::Max(TMath::Min((tmpNeutralHadronIso_DR0p5To0p7 - rho*MuonEffectiveArea(kMuNeutralHadronIsoDR0p5To0p7, mu->eta, EffectiveAreaVersion))/mu->pt, 2.5), 0.0);
        fNeutralHadronIso_DR0p7To1p0 = TMath::Max(TMath::Min((tmpNeutralHadronIso_DR0p7To1p0 - rho*MuonEffectiveArea(kMuNeutralHadronIsoDR0p7To1p0, mu->eta, EffectiveAreaVersion))/mu->pt, 2.5), 0.0);
          ...
          if (dr < 1.0) {
            ...
            for (Int_t q=0; q < IdentifiedLeptonType.size() ; ++q) {
              ...
              if (IdentifiedLeptonType[q] == 13) {
                ...
                if (pf->q != 0 && mithep::MathUtils::DeltaR(tmpmu->phi,tmpmu->eta, pf->phi, pf->eta) < 0.010) IsLeptonFootprint = kTRUE;                
              }
            }
          }
  ...
  cout << "IsoOverlap Study" << endl;
  cout << "NMuons: " << NMuons << endl;
  cout << "NMuonsWithOverlappingLeptonThatIsNotRemoved : " << NMuonsWithOverlappingLeptonThatIsNotRemoved << endl;
  cout << "NMuonsWithFakeLeptonThatWasRemoved : " << NMuonsWithFakeLeptonThatWasRemoved << endl;

  outputFile->Write();
  outputFile->Close();


  TFile *histFile = new TFile("ElectronIsoMVAPerformancePlots.root","UPDATE");
  histFile->WriteTObject(GenLeptonMinDR,GenLeptonMinDR->GetName(), "WriteDelete") ;
  histFile->Close();
