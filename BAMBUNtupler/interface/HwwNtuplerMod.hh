#ifndef HIGGSANA_BAMBUNTUPLER_HWWNTUPLERMOD_H
#define HIGGSANA_BAMBUNTUPLER_HWWNTUPLERMOD_H
...
//               << secondObjectModuleName << " " << secondObjectId << endl;
    ...
    protected:
      ...
      void FillCaloJet(const CaloJet *jet);
     ...
     // Match electron to HLT primitive
      ...
      higgsana::TEventInfo              fEventInfo;       // general event information
      higgsana::TGenInfo                fGenInfo;         // generator information
      TClonesArray           *fElectronArr;     // electron array
      TClonesArray           *fMuonArr;         // muon array
      TClonesArray           *fPFJetArr;        // particle flow jet array
      TClonesArray           *fCaloJetArr;      // calo jet array
      ...
      EGEnergyCorrector *egcorHgg2011;
      EGEnergyCorrector *egcorHgg2012;
