  ...
  )
{
  ...
  GeneratorMod1->SetEtaRadPhotonMax(5.0);
  ...
  jetCorr1_ntuple->AddCorrectionFromFile("/afs/cern.ch/user/s/sixie/CMSSW_analysis/src/MitPhysics/data/MitPhysics/data/START42_V12_AK5PF_L1FastJet.txt"); 
  jetCorr1_ntuple->AddCorrectionFromFile("/afs/cern.ch/user/s/sixie/CMSSW_analysis/src/MitPhysics/data/MitPhysics/data/START42_V12_AK5PF_L2Relative.txt"); 
  jetCorr1_ntuple->AddCorrectionFromFile("/afs/cern.ch/user/s/sixie/CMSSW_analysis/src/MitPhysics/data/MitPhysics/data/START42_V12_AK5PF_L3Absolute.txt");
  if(isData == true){
    jetCorr1_ntuple->AddCorrectionFromFile("/afs/cern.ch/user/s/sixie/CMSSW_analysis/src/MitPhysics/data/MitPhysics/data/START42_V12_AK5PF_L2L3Residual.txt");  
  }
